...
module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    await queryInterface.sequelize.query('DROP TYPE IF EXISTS "enum_Staffs_gender";');
    await queryInterface.sequelize.query('DROP TYPE IF EXISTS "enum_Staffs_maritalStatus";');
    await queryInterface.sequelize.query('DROP TYPE IF EXISTS "enum_Staffs_nationality";');
    await queryInterface.sequelize.query('DROP TYPE IF EXISTS "enum_Staffs_status";');
  }
};