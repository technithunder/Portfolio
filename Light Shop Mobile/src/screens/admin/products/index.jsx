...
import {CustomConfirmModal, Icon, Typography} from '../../../components';
...
const NewHome = ({navigation}) => {
  ...
  const fetchAllProducts = async (
    ...
    try {
      ...
      console.log('Parameters:', {
        ...
        reset: reset,
        isFromCategoryChange: isFromCategoryChange,
      });
  ...
  const onPressLikeBtn = async productId => {
    ...
    navigation.navigate(Routes.AddProduct, {productId: productId});
  };
  ...
  const handleConfirm = async () => {
    try {
      ...
      const response = await removeProduct(selectProductId);
      if (response?.data?.status === 'success') {
        Toast.show({
          type: 'success',
      ...
      return (
        <TouchableOpacity
          ...
          <View style={{position: 'relative'}}>
            ...
            <AntDesign name="edit" size={18} color={COLORS.APP_BLACK} />
          </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            <MaterialIcons name="delete" size={18} color={COLORS.APP_RED} />
          </TouchableOpacity> */}
          </View>
            ...
            <View
              ...
              {item?.productPrice && (
                <Typography
                  ...
                  color={
                    item.afterDiscountPrice ? COLORS.APP_GRAY : COLORS.APP_BLACK
                  }
                  mt={2}
                  style={{
    ...
    return (
      <View style={styles.headerContainer}>
        ...
        <View style={{flexDirection: 'row', alignItems: 'center', gap: 10}}>
          <Typography title={'Products'} size={20} font={FONTS.INTER_MEDIUM} />
        </View>
        <View />
        {/* <TouchableOpacity onPress={() => navigation.navigate(Routes.AddProduct)}> */}
        {/* <TouchableOpacity onPress={renderOptions}>
