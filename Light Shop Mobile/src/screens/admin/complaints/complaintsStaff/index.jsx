...
import { addComplaintStaff, addLeadStaff, getAllUsers } from '../../../../api';
...
const LeadStaff = ({navigation}) => {
  ...
  const handleAddStaff = async () => {
    ...
    console.log(obj)
    try {
      const response = await addComplaintStaff(obj);
      if (response?.data?.status === 'success') {
        console.log("Welcome")
        navigation.navigate(Routes.AdminViewComplaints,{complaintId: complaintId});
      }
    } catch (e) {
      console.log(e);
    }
