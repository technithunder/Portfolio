...
const Profile = () => {
  ...
  return (
    <Container
      title={data?.BasicInfo?.empId || 'Customer Profile'}
      ...
      onRightPress={() =>
        navigate(Routes.AdminCustomerEditProfile, {
          customerId: data?.BasicInfo?.id,
        })
      }>
      {loading ? (
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <View
            style={{marginHorizontal: 20, marginTop: 100, paddingBottom: 50}}>
            ...
            <View style={{marginTop: 20}}>
              <TouchableOpacity
                ...
                onPress={() =>
                  navigate(Routes.AdminCustomerOrder, {
                    customerId: data?.BasicInfo?.id,
                  })
                }>
                <Typography
              ...
              <AccordionSection
                ...
                {data?.BankInfo?.bankName && (
                  <InfoRow label="Bank Name" value={data?.BankInfo?.bankName} />
                )}
                ...
                {data?.BankInfo?.ifscCode && (
                  <InfoRow label="IFSC Code" value={data?.BankInfo?.ifscCode} />
                )}
