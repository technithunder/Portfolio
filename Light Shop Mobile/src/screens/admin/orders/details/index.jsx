...
const NewOrderDetail = ({navigation}) => {
  ...
  const isDashboard = route?.params?.isDashboard;
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            isTodayOrder
              ...
              : isDashboard
              ? navigation.navigate(Routes.ViewOrder)
