...
import {addOrderStaff, getAllUsers} from '../../../../../api';
import {TextInput} from 'react-native-gesture-handler';
import {useRoute} from '@react-navigation/native';

const SelectStaff = ({navigation}) => {
  ...
  const handleAddStaff = async () => {
    ...
    try {
      const response = await addOrderStaff(obj);
      if (response?.data?.status === 'success') {
        console.log("Welcome")
        navigation.navigate(Routes.AdminOrdersDetail,{orderId: orderId});
      }
    } catch (e) {
      console.log(e);
    }
