  ...
  return (
    <>
      <UserBoxButton color="primary" ref={ref} onClick={handleOpen}>
        <UserAvatar alt={user?.name} src={'/static/images/avatars/client-profile.jpeg'} />
      </UserBoxButton>
      <Popover
        disableScrollLock
      ...
      >
        <MenuUserBox
          ...
          display="flex"
        >
          <Avatar sx={{objectFit:"contain"}} variant="rounded" alt={user?.name} src={'/static/images/avatars/client-profile.jpeg'} />
          <UserBoxText>
